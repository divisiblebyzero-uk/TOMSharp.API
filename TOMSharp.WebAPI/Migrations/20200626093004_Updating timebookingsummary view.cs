...
{
    public partial class Updatingtimebookingsummaryview : Migration
    {
...
select s.Name as Sprint, p.Team as Team, p.Name as Person, sum(convert(decimal(16,2), dur))/1000/60/60 as Hours, s.FinanceYear as FinanceYear
  from timeentries te,
       sprints s,
       people p
