...
{
    public partial class updatingtimebookingsummariesview : Migration
    {
...
select s.Id as SprintId, s.Name as Sprint, p.Team as Team, p.Name as Person, sum(te.dur)/1000/60/60 as Hours, s.FinanceYear as FinanceYear
  from timeentries te,
       sprints s,
       people p
