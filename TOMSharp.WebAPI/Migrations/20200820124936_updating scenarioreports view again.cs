...
{
    public partial class updatingscenarioreportsviewagain : Migration
    {
...
select null as ScenarioId, 'TimeEntry' as ForecastName, Project, FinanceMonth, FinanceYear, sum(convert(decimal(16,2), dur))/1000/60/60 as Hours, min(sprints.startDate) as MonthStartDate, sprints.Name as Sprint, sprints.Id as SprintId
  from timeentries
 ...
 group by Project, FinanceMonth, FinanceYear, sprints.Name, sprints.Id
union
